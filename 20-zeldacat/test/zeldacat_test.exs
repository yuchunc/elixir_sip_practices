defmodule ZeldacatTest do
  ...
  test "something with an WeaponComponent can manage a list of weapons" do
    {:ok, entity} = Entity.init()
    ...
    Entity.notify(entity, {:add_weapon, "screw driver"})
    assert WeaponComponent.list_weapons(entity) == ["bat", "screw driver"]
  end
end
