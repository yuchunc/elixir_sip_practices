# Event Sourcing
# Events are stored and use for calcualtions.
# The process mantains a history of everything that happened.
# CQRS - Command Query Responsibility Segregation
# Message in Actors are always Command or Query but never both.
# Seperating the concerns and responsibility makes the encapsulation more clear.
# and the state of your actor more concise
...
defmodule BankAccount do
  ...
  defp divulge_balance(pid, events) do
    send pid, {:balance, calculated_balance(events)}
  end
  ...
  defp calculated_balance(events) do
